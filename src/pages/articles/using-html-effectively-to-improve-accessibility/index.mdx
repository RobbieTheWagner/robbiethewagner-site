...
without understanding the fundamentals of HTML, CSS, and JavaScript. It can be tempting to skip the "easy" stuff and just learn it on the job, but you are setting yourself up for failure
