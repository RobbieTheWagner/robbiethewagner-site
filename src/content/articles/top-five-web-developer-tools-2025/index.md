...
[![Screenshot of Warp showing a command that was run and its output colocated in one block.](./img/warp-blocks.webp)](https://www.warp.dev/warp-ai)
...
[![Screenshot of Warp AI explaining how to use grep to do regex based searches.](./img/warp-ai.webp)](https://www.warp.dev/warp-ai)
...
[![Screenshot of a Warp Drive notebook showing documentation and a list of commands.](./img/warp-drive-notebook.webp)](https://www.warp.dev/warp-drive)
...
[![Screenshot of VSCode Insiders editing this very blog post!](./img/vscode.png)](https://code.visualstudio.com/insiders/)
...
[![Screenshot of Arc showing GitHub open, some tabs on the left and a favorites bar](./img/arc.png)](https://thebrowser.company/)
...
[![Screenshot of Arc showing the command palette.](./img/arc-command-palette.png)](https://thebrowser.company/)
...
[![Screenshot of GitHub Desktop showing history and file changes](./img/github-desktop.png)](https://desktop.github.com/)
...
[![Screenshot of GitHub Desktop showing the create pull request button](./img/github-desktop-pr.png)](https://desktop.github.com/)
...
[![Screenshot of Kaleidoscope showing a diff of two versions of a file and combining them into one merged file.](./img/kaleidoscope.jpg)](https://kaleidoscope.app/)
