...
```css title="smooth-accordion.css"
details {
  padding-top: 16px;
  padding-bottom: 16px;
}
...
<details class="group py-4">
  <summary class="-mb-4 cursor-pointer transition-all group-open:mb-4">
    <span>What's the best fast food?</span>
  </summary>
  <strong>Taco Bell</strong>
</details>
...
<div class="flex items-center">
  <progress
    class="progress-unfilled:bg-[#F2F2F2] progress-filled:bg-cyan-700"
    value="750"
    max="1000"
  >
    <span>75%</span>
